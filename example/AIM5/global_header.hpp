...
//
//001206 Created by Peter H Zipfel
//011129 Adapted to MISSILE6 simulation, PZi
//081010 Modified for GENSIM simulation, PZi
...
//
//010107 Created by Peter H Zipfel
///////////////////////////////////////////////////////////////////////////////
struct Module
{
	string name;
...
//
//001125 Created by Peter H Zipfel
//011129 Adapted to MISSILE6 simulation, PZi
//071101 Added VEC5 and MAT5, PZi
///////////////////////////////////////////////////////////////////////////////
...
private:
	...
	Matrix VEC5;	  //5x1 vector 
	Matrix MAT5;	  //5x5 matrix 
	char def[CHARL];  //definition and units
	char mod[CHARN];  //module where variable is calculated
	char role[CHARN]; //role that variable plays: 'data','state','diag','out','save'
...
public:
	Variable()
	{
		...
		VEC5.dimension(5,1);MAT5.dimension(5,5);		
		strcpy(name,"empty");
		error[0]=' ';error[1]='\0';
		int dum=1;
	}; 
...
void init(char *na,double v1,double v2,double v3,double v4,double v5,
...
////////////////////////// Inline Functions ///////////////////////////////////
	...
	//Example: double thrust_com=aim[13].real();
	//
	...
	//Example: int mprop=aim[10].integer();
	//
	//001128 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	...
	//Example: Matrix FSPV=flat3[200].vec();
	//
	//001128 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	...
	//Example: Matrix TGV=flat3[22].mat();
	//
	//001226 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	Matrix mat(){return MAT;}
	///////////////////////////////////////////////////////////////////////////
	//Obtaining 5x1 vector value (of type 'Matrix') from module-variable array to local variable
	//Example: Matrix X=flat3[200].vec5();
	//
	//071101 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	Matrix vec5(){return VEC5;}
	
	///////////////////////////////////////////////////////////////////////////
	//Obtaining 5x5 matrix value (of type 'Matrix') from module-variable array to local variable
	//Example: Matrix P=flat3[22].mat5();
	//
	//071101 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	Matrix mat5(){return MAT5;}
	
	///////////////////////////////////////////////////////////////////////////
	//Loads module-variable onto module-variable array
	//Overloaded for real and integer variables
	//Example: aim[10].gets(mprop);
	//
	//001128 Created by Peter H Zipfel
	//071101 Added vector 5x1  and matrix 5x5 member functions, PZi
	///////////////////////////////////////////////////////////////////////////
	...
	Matrix gets_vec5(Matrix VE5)
	{
		VEC5=VE5;
		return VEC5;
	} 

	Matrix gets_mat5(Matrix MA5)
	{
		MAT5=MA5;
		return MAT5;
	} 
	...
	//
	//020909 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	...
	//020911 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
...
//
//010119 Created by Peter H Zipfel
//011129 Adapted to MISSILE6 simulation, PZi
///////////////////////////////////////////////////////////////////////////////
class Event
{
private:
	...
	int flat3_indices[NVAR];	//new variables to be read from 'flat3[]'
	double flat3_values[NVAR];	//new values to be given to variables 
	int flat3_size;				//size (number) of variables from flat3 array
	int aim_indices[NVAR];	//new variables to be read from 'aim[]'
	double aim_values[NVAR];	//new values to be given to variables
	int aim_size;				//size (number) of variables from aim array
public:
	Event(){};
	~Event(){};
	...
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	...
	///////////////////////////////////////////////////////////////////////////
	//Setting index array of 'flat3' module-variable array that are used for event
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	void set_flat3_index(int element,int index){flat3_indices[element]=index;}

	///////////////////////////////////////////////////////////////////////////
	//Setting values of new 'flat3' event variables
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	void set_flat3_value(int element,double value){flat3_values[element]=value;}

	///////////////////////////////////////////////////////////////////////////
	//Setting size of new 'flat3' event variable array
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	void set_flat3_size(int size){flat3_size=size;}

	///////////////////////////////////////////////////////////////////////////
	//Setting index array of 'aim' module-variable array that are used for event
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	void set_aim_index(int element,int index){aim_indices[element]=index;}

	///////////////////////////////////////////////////////////////////////////
	//Setting values of 'aim' event variables
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	void set_aim_value(int element,double value){aim_values[element]=value;}

	///////////////////////////////////////////////////////////////////////////
	//Setting size of new 'aim' event variable array
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	void set_aim_size(int size){aim_size=size;}
	...
	///////////////////////////////////////////////////////////////////////////
	//Getting index array of 'flat3' module-variable array that are used for event
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	int *get_flat3_indices(){return flat3_indices;}

	///////////////////////////////////////////////////////////////////////////
	//Getting values of new 'flat3' event variables
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	double *get_flat3_values(){return flat3_values;}

	///////////////////////////////////////////////////////////////////////////
	//Getting size of new 'flat3' event variable array
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	int get_flat3_size(){return flat3_size;}

	///////////////////////////////////////////////////////////////////////////
	//Getting index array of 'aim' module-variable array that are used for event
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	int *get_aim_indices(){return aim_indices;}

	///////////////////////////////////////////////////////////////////////////
	//Getting values of new 'aim' event variables
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	double *get_aim_values(){return aim_values;}

	///////////////////////////////////////////////////////////////////////////
	//Getting size of new 'aim' event variable array
	//
	//010123 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	int get_aim_size(){return aim_size;}
};
...
//070531 New method 'set_data_variable(...)', PZi
///////////////////////////////////////////////////////////////////////////////
class Packet
{
private:
	string id;			//identification of vehicle object
	int status;			//alive=1, dead=0 . hit=-1 (targets are only stopped), 
...
public:
	...
	//Setting packet 'data'
	//
	//070531 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	void set_data_variable(int slot,double value){(data+slot)->gets(value);}
...
//
//020913 Created by Peter H Zipfel
///////////////////////////////////////////////////////////////////////////////
