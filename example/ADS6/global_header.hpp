...
////////////////////////// Inline Functions ///////////////////////////////////
	...
	//Example: Matrix X=flat6[200].vec5();
	//
	...
	//Example: Matrix P=flat6[22].mat5();
	//
	//071101 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
...
private:
	...
	int missile_size;				//size (number) of variables from missile array
public:
	Event(){};
	~Event(){};
...
private:
	...
	int status;			//alive=1, dead=0 . hit=-1 (rockets are only stopped), 
...
//
//010924 Created by Peter H Zipfel
//020723 Included 'saved' private data member, PZi
///////////////////////////////////////////////////////////////////////////////
class Markov
{
private:
	int flat6_index;	//markov variable index of 'flat6[]'
	int flat3_index;	//markov variable index of 'flat3[]'
	int flat0_index;	//markov variable index of 'flat0[]'
	int vehicle_index;	//markov variable index of vehicle array ('missile[]','rocket[]','aircraft[]')
...
public:
	...
	///////////////////////////////////////////////////////////////////////////
	//Setting index of markov variable of 'flat3[]'
	//
	//070419 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	void set_markov_flat3_index(int index){flat3_index=index;}
	...
	///////////////////////////////////////////////////////////////////////////
	void set_markov_flat0_index(int index){flat0_index=index;}

	///////////////////////////////////////////////////////////////////////////
	//Setting index of markov variable index of vehicle array ''missile[]','rocket[]','aircraft[]'
	//
	//010924 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	...
	//
	//020723 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	...
	///////////////////////////////////////////////////////////////////////////
	//Getting index of markov variable of 'flat3[]'
	//
	//070419Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
	int get_markov_flat3_index(){return flat3_index;}

	///////////////////////////////////////////////////////////////////////////
	//Getting index of markov variable index of vehicle array 'missile[]','rocket[]','aircraft[]'
	//
	//010924 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////
